...
namespace EFCore_Peliculas.Migrations
{
    ...
    public partial class DataMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "SalasDeCine",
                columns: new[] { "Id", "CineId", "Precio", "SalaDeCineId", "TipoSalaDeCine" },
                values: new object[,]
                {
                    { 1, 1, 220m, null, 1 },
                    { 2, 1, 320m, null, 2 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 9, 30, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 9, 23, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2023, 9, 28, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 9, 23, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
